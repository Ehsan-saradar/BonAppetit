        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RestaurantUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuItems_RestaurantUsers_RestaurantUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_RestaurantRates_Order_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Order",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RestaurantRates_RestaurantUsers_RestaurantUserId",
                        column: x => x.RestaurantUserId,
                        principalTable: "RestaurantUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItems_RestaurantUserId",
                table: "MenuItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RestaurantRates_OrderId",
                table: "RestaurantRates",
                column: "OrderId");

            migrationBuilder.CreateIndex(
                name: "IX_RestaurantRates_RestaurantUserId",
                table: "RestaurantRates",
                column: "RestaurantUserId");
        }
